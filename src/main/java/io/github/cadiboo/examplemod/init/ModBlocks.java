...
import io.github.cadiboo.examplemod.block.ModDickBlock;
...
public final class ModBlocks {
	...
	//pruebas de bloque
	public static final RegistryObject<Block> MOD_DICK = BLOCKS.register("mod_dick", () -> new ModDickBlock(Block.Properties.create(Material.IRON, MaterialColor.IRON).hardnessAndResistance(2.0F, 2.0F).lightValue(13).sound(SoundType.METAL)));
}
